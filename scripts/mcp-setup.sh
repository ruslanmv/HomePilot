...
# =============================================================================
# HomePilot – MCP Context Forge Configuration
# =============================================================================
# This file is auto-generated by HomePilot's install-mcp target.
# Edit freely; it will NOT be overwritten on subsequent installs.
# =============================================================================
...
# ── Authentication ───────────────────────────────────────────────────────────
# Disable login prompt so the Admin UI opens without a password (DEV ONLY).
# Set AUTH_REQUIRED=true for production / shared networks.
AUTH_REQUIRED=false

# Prevent login/cookie issues when serving over plain HTTP locally
SECURE_COOKIES=false

# ── Default Credentials ─────────────────────────────────────────────────────
# These are used when AUTH_REQUIRED=true.
#
#   Admin UI login (email auth):
...
# ── Password Policy (relaxed for local development) ─────────────────────────
...
# Relax complexity rules so "changeme" works without complaint
...
# ── Admin UI & API ───────────────────────────────────────────────────────────
# Required for "Open Tool & Agent Manager" in HomePilot Settings
