...
// 4. HELPER FUNCTIONS
// =============================================================================
const DEFAULT_ARCH = "sd15";
const DEFAULT_ASPECT = "1:1";
const DEFAULT_PRESET = "med";
/**
 * Detect architecture from model filename using heuristics.
 */
export function detectArchitecture(modelFilename) {
    if (!modelFilename)
        return DEFAULT_ARCH;
 ...
 */
export function getResolutionTable(arch) {
...
export function normalizeAspectRatio(aspectRatio) {
    ...
    return valid.includes(aspectRatio) ? aspectRatio : DEFAULT_ASPECT;
}
/**
 * Normalize preset to valid value.
 */
export function normalizePreset(preset) {
    const valid = ["low", "med", "high", "ultra"];
    return valid.includes(preset) ? preset : DEFAULT_PRESET;
}
/**
 ...
 */
export function getModelSettings(modelFilename, aspectRatio = "1:1", preset = "med") {
 ...
 */
export function getPresetDescription(modelFilename, preset) {
 ...
 */
export function getArchitectureLabel(arch) {
    return {
        sd15: "SD 1.5",
        sdxl: "SDXL",
        flux_schnell: "Flux Schnell",
