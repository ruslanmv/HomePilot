...
export function CharacterCreatorStudio({
  ...
  // ── Phase 2: Outfit ──
  const [selectedOutfitPreset, setSelectedOutfitPreset] = useState<string | null>('corporate')
  ...
  const [deletedOutfit, setDeletedOutfit] = useState<{ item: AvatarResult; index: number } | null>(null)
  ...
  const handleSaveIdentity = useCallback(() => {
    ...
    gallery.addAnchorWithPortraits(
      ...
      undefined,
      { vibeTag: selectedStyle || undefined, nsfw: isSpicy || undefined, wizardMeta, framingType: bodyFraming },
    )
  ...
  const handleGenerateOutfits = useCallback(async () => {
    ...
    try {
      ...
      if (result?.results?.length) {
        ...
        const scenarioForResults: OutfitScenarioTag = (selectedOutfitPreset as OutfitScenarioTag) || 'custom'
        ...
        gallery.addBatch(
          ...
          savedIdentity.url,
          scenarioTag,
          { parentId: savedIdentity.id, nsfw: (outfitTab !== 'standard') || undefined },
        )
              ...
              <>
                ...
                <div>
                  ...
                  {selectedOutfitPreset && (() => {
                    ...
                    return (
                      <div className="mt-2 px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.06] animate-fadeIn">
              ...
              <>
                ...
                <div className="rounded-xl border border-purple-500/20 bg-gradient-to-b from-purple-500/8 to-transparent overflow-hidden">
                  ...
                  <div className="px-4 py-2.5 border-b border-purple-500/15 flex items-center gap-2">
                    ...
                    {allOutfits.length > 0 && (
                      <span className="ml-auto text-[9px] px-2 py-0.5 rounded-full bg-cyan-500/15 text-cyan-300/70 font-medium">
        ...
        {phase === 'identity' ? (
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative flex items-stretch">
                ...
                <div className="relative">
                  <button
                    onClick={() => setShowFaceCountMenu(!showFaceCountMenu)}
                    className={[
                  ...
                  {showFaceCountMenu && (
                    <>
                      ...
                      <div className="absolute right-0 bottom-full mb-1 bg-[#1a1a1a] border border-white/10 rounded-lg shadow-2xl z-40 overflow-hidden min-w-[80px]">
                        {[1, 4, 8].map((n) => (
                          <button key={n}
                            onClick={() => { setFaceCount(n); setShowFaceCountMenu(false) }}
                            className={[
          ...
          <>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative flex items-stretch">
                ...
                <div className="relative">
                  <button
                    onClick={() => setShowBodyCountMenu(!showBodyCountMenu)}
                    className={[
                      'h-full px-2.5 rounded-r-xl border-l transition-all flex items-center',
                      !bodyGen.loading
                  ...
                  {showBodyCountMenu && (
                    <>
                      ...
                      <div className="absolute right-0 bottom-full mb-1 bg-[#1a1a1a] border border-white/10 rounded-lg shadow-2xl z-40 overflow-hidden min-w-[80px]">
                        {[1, 4, 8].map((n) => (
                          <button key={n}
                            onClick={() => { setBodyCount(n); setShowBodyCountMenu(false) }}
                            className={[
                              'w-full px-4 py-2 text-left text-sm transition-colors',
          ...
          <>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative flex items-stretch">
                ...
                <div className="relative">
                  <button
                    onClick={() => setShowOutfitCountMenu(!showOutfitCountMenu)}
                    className={[
                      'h-full px-2.5 rounded-r-xl border-l transition-all flex items-center',
                      !outfitGen.loading && effectiveOutfitPrompt
                  ...
                  {showOutfitCountMenu && (
                    <>
                      ...
                      <div className="absolute right-0 bottom-full mb-1 bg-[#1a1a1a] border border-white/10 rounded-lg shadow-2xl z-40 overflow-hidden min-w-[80px]">
                        {[1, 4, 8].map((n) => (
                          <button key={n}
                            onClick={() => { setOutfitCount(n); setShowOutfitCountMenu(false) }}
                            className={[
                              'w-full px-4 py-2 text-left text-sm transition-colors',
          ...
          <>
            ...
            <div className="flex items-center gap-2">
              ...
              {onSaveAsPersonaAvatar && savedIdentity && (
                <button
                  onClick={() => {
                    const outfitItems = gallery.items.filter((i) => i.parentId === savedIdentity.id && i.scenarioTag)
                    const batchSiblings = gallery.items.filter((i) =>
                      i.batchId === savedIdentity.batchId && i.id !== savedIdentity.id && i.role === 'portrait',
                    )
      ...
      {toast && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-toastSlideUp">
          <div className={[
            ...
            {deletedOutfit && (
              <button onClick={handleUndoDeleteOutfit}
                className="ml-1 px-2.5 py-1 rounded-lg bg-white/10 hover:bg-white/20 text-xs font-semibold text-white/80 transition-all"
              >
                Undo
              </button>
            )}
