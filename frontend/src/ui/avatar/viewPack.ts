...
export const VIEW_ANGLE_OPTIONS: ViewAngleOption[] = [
  ...
  },
  {
    ...
    label: 'Right',
    shortLabel: 'R',
    prompt: 'character turntable, full right profile, standing upright, camera directly to the left of subject, head turned 90 degrees right, only right side of face visible, right ear jaw line nose tip in silhouette, standing pose, legs straight, feet on floor',
  ...
  },
  {
    ...
    label: 'Left',
    shortLabel: 'L',
    prompt: 'character turntable, full left profile, standing upright, camera directly to the right of subject, head turned 90 degrees left, only left side of face visible, left ear jaw line nose tip in silhouette, standing pose, legs straight, feet on floor',
    negativePrompt: 'front view, facing camera, both eyes visible, symmetrical face, three-quarter view, 45 degree turn, back view, rear view, sitting, kneeling, crouching, lying down, on the floor, on the ground, cross-legged',
    icon: '\u25D0',
    denoise: 1.0,
    skipIdentity: true,
