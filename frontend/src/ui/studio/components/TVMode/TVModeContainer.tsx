...
import { useTVModeStore, selectCurrentScene, selectSceneDuration, selectIsLastScene } from "../../stores/tvModeStore";
...
export const TVModeContainer: React.FC<TVModeContainerProps> = ({
  ...
  }, [isPlaying, currentSceneIndex, currentScene, sceneDuration, isLastScene, showEndScreen]);

  // Prefetch next scene
  const handlePrefetch = useCallback(async () => {
    if (isPrefetching || scenes.length >= 24) return;
