...
import { studioPost } from "../lib/api";
...
export function StudioNewWizard() {
  ...
  // Wizard fields (mapped safely into tags)
  ...
  async function handleCreate() {
    ...
    try {
      ...
      const j = await studioPost<{ video: { id: string } }>("/studio/videos", payload);
      nav(studioPaths.videoTab(j.video.id, "overview"));
    } catch (e: any) {
  ...
  return (
    <div className="min-h-screen w-full bg-[#0f0f0f] text-[#f1f1f1] flex items-center justify-center p-5">
