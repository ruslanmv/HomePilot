...
import type { CapabilityItem, CatalogA2AAgent, CatalogTool } from '../../agentic/types'
...
export function ToolDetailDrawer({ item, onClose }: Props) {
  ...
  const toolUrl = kind === 'tool' ? (data as CatalogTool).url : undefined
        ...
        <div className="px-6 py-6 space-y-6">
          ...
          <div className="pt-2 border-t border-white/5">
            <button
              ...
              title={`Copy ${isA2A ? 'agent' : 'tool'} ID`}
            >
