 ...
 */
export function detectAgenticIntent(raw) {
    const text = (raw || '').trim();
    if (!text)
        return { intent: null, prompt: '' };
    ...
    const wantsImageVerb = lower.includes('generate') || lower.includes('create') || lower.includes('make') || lower.includes('draw');
    const wantsImageNoun = lower.includes('image') || lower.includes('picture') || lower.includes('photo') || lower.includes('portrait') || lower.includes('art');
    const wantsImagePhrase = lower.includes('a picture of') || lower.includes('an image of') || lower.includes('generate me') || lower.includes('create an image');
