        ...
        <div className="px-4 pb-3 space-y-3 border-t border-white/5">
          ...
          <div className="flex gap-2 pt-1">
            <button
              onClick={onRefresh}
              disabled={loading}
              className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-xs text-white/60 hover:bg-white/10 transition-colors disabled:opacity-40"
            >
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-red-500/10 border border-red-500/20 rounded-lg text-xs text-red-400 hover:bg-red-500/20 transition-colors"
            >
              <Unplug size={12} />
              Disconnect
            </button>
...
export function BridgeBadge({
  ...
  return (
    <button
      onClick={onClick}
      className="flex items-center gap-1.5 px-2.5 py-1 bg-blue-500/15 border border-blue-500/20 rounded-full text-xs text-blue-300 hover:bg-blue-500/25 transition-colors"
      title="Teams Bridge connected"
    >
      <div className="relative">
        <Wifi size={11} />
