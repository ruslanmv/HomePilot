 ...
 */
export function getEngagementHook(id, trigger) {
    const strategy = getConversationStrategy(id);
    const applicable = strategy.engagementHooks.filter((h) => h.trigger === trigger && Math.random() < h.probability);
 ...
 */
export function getSilenceResponse(id) {
    const strategy = getConversationStrategy(id);
 ...
 */
export function getEmpathyPhrase(id) {
    const strategy = getConversationStrategy(id);
 ...
 */
export function getActiveListeningCue(id) {
    const strategy = getConversationStrategy(id);
 ...
 */
export function buildEnhancedPrompt(basePrompt, strategy) {
