 ...
 */
export function isAdultContentEnabled() {
 ...
 */
export function setAdultContentEnabled(enabled) {
    if (typeof window === 'undefined')
        return;
 ...
 */
export function setAgeConfirmed(confirmed) {
    if (typeof window === 'undefined')
        return;
 ...
 */
export function getEnabledPersonalities() {
 ...
 */
export function isPersonalityAccessible(id) {
 ...
 */
export function isPersonasEnabled() {
    if (typeof window === 'undefined')
        return false;
 ...
 */
export function setPersonasEnabled(enabled) {
    if (typeof window === 'undefined')
        return;
 ...
 */
export function isVoiceLinkedToProject() {
    if (typeof window === 'undefined')
        return false;
 ...
 */
export function setVoiceLinkedToProject(linked) {
    if (typeof window === 'undefined')
        return;
 ...
 */
export function getVoiceLinkedProjectId() {
    if (!isVoiceLinkedToProject() || !isPersonasEnabled())
        return undefined;
 ...
 */
export function getActiveVoiceSessionConversationId() {
    try {
