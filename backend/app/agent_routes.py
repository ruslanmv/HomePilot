...
class AgentChatIn(BaseModel):
    ...
    # explicit image URL (from frontend upload — avoids relying on conversation history)
    image_url: Optional[str] = Field(None, description="Image URL to analyze (e.g. /files/<asset_id>)")
