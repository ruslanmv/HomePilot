...
NSFW_LORAS: List[LoRAEntry] = [
    ...
    # --- Undressing LoRA — SD 1.5 version (DreamShaper 8 compatible) ---
    LoRAEntry(
        id="undressing_sd15",
        name="Undressing LoRA (SD 1.5)",
        base="sd1.5",
        source="civitai",
        model_url="https://civitai.com/models/242034/undressing-lora-sd15-and-sdxl10",
        download_url="https://civitai.com/api/download/models/273498?type=Model&format=SafeTensor",
        filename="undressing_sd15.safetensors",
        description="Progressive undressing LoRA for SD1.5. Higher weight = more undressing. Works great with DreamShaper 8.",
        size_mb=144,
        trigger_words=["undressing"],
        gated=True,
        recommended_nsfw=True,
    ),
    # --- Undressing LoRA — SDXL version ---
    LoRAEntry(
        id="undressing_sdxl",
        name="Undressing LoRA (SDXL)",
        base="sdxl",
        source="civitai",
        model_url="https://civitai.com/models/242034/undressing-lora-sd15-and-sdxl10",
        download_url="https://civitai.com/api/download/models/277000?type=Model&format=SafeTensor",
        filename="undressing_sdxl.safetensors",
        description="Progressive undressing LoRA for SDXL. Higher weight = more undressing.",
        size_mb=144,
        trigger_words=["undressing"],
        gated=True,
        recommended_nsfw=True,
    ...
    LoRAEntry(
        ...
        base="sd1.5",
        source="civitai",
        model_url="https://civitai.com/models/247254/cnd-nsfw-lora",
        download_url="https://civitai.com/api/download/models/442947?type=Model&format=SafeTensor",
        filename="cnd_nsfw.safetensors",
        description="Realistic NSFW poses LoRA for SD1.5. Best at weight 0.7 with realistic checkpoints like DreamShaper 8.",
        size_mb=37,
        trigger_words=["spread legs", "pov", "deep penetration"],
        gated=True,
        recommended_nsfw=True,
    ),
    LoRAEntry(
        id="ultimate_milf_sd15",
        name="Ultimate Milf/Mommy (SD 1.5)",
        base="sd1.5",
        source="civitai",
        model_url="https://civitai.com/models/399818?modelVersionId=445917",
        download_url="https://civitai.com/api/download/models/445917?type=Model&format=SafeTensor",
        filename="ultimate_milf_sd15.safetensors",
        description="Mature female body types LoRA for SD1.5. Trained on 1229 images. Compatible with DreamShaper 8.",
        size_mb=36,
        trigger_words=["milf", "mature female", "wide hips", "hourglass figure"],
        gated=True,
        recommended_nsfw=True,
    ),
    # =========================================================================
