...
@echo ""
@echo "UI      : [http://localhost:3000](http://localhost:3000)"
@echo "Backend : [http://localhost:8000/docs](http://localhost:8000/docs)"
@echo "LLM API : [http://localhost:8001/v1](http://localhost:8001/v1)"
@echo "ComfyUI : [http://localhost:8188](http://localhost:8188)"
@echo ""
...
@curl -fsS [http://localhost:8000/health](http://localhost:8000/health) | jq . || true
@curl -fsS [http://localhost:8188/system_stats](http://localhost:8188/system_stats) | jq . || true
@curl -fsS [http://localhost:8001/v1/models](http://localhost:8001/v1/models) | jq . || true
